...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'chuck', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '热爱阅读的程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.qukun.com.cn/', // 网站地址
